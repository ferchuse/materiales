<?php
	...
	function copiarFactura($link,$id_facturas){
		...
		$consulta_detalle = "SELECT * FROM salidas_productos 
		WHERE id_facturas = '$id_facturas'
														...
														<div class="impuestos col-sm-8">
															<div class="fila_impuesto row">
																...
																<div class="form-group col-sm-2">
																	<label>Base:</label>
																	<input  name="base[<?php echo $i;?>][]" value="0" type="number" min="0" step="any"  class="form-control base" value="<?php echo $importe;?>">
																</div>
																<div class="form-group col-sm-2 ">
																	<label>Tasa:</label>
