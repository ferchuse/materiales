...
<html lang="es">
  <head>
    ...
    <title>NUEVA <?PHP ECHO $_GET["tipo_movimiento"]?></title>
  ...
  <body>
		...
		<div class="container-fluid d-print-none">
			<div class="row">
				...
				<input type="hidden" id="tabla" value="<?php echo $_GET["tabla"]?>">
				<div class="col-md-3">
				...
				<div class="form-group col-sm-2">
					...
					<input id="referencia" form="form_movimientos" required name="referencia" type="text" class="form-control"  >
				</div>
			...
			<section id="footer">
				<form id="form_movimientos" autocomplete="off">
					<div class="row">
						...
						<div class="col-sm-1 col-6 h3 venta">
								<input readonly  id="total" type="text" class="form-control input-lg text-right venta" value="0" name="total">
						</div>
		...
		<script src="nuevo_movimiento.js"></script>
